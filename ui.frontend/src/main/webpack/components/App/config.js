 ...
 ******************************************************************************/
 export default {
    ...
    pagePaths: {
        addressBook: '/content/wknd/us/en/my-account/address-book.html',
        baseUrl: document.querySelector('body').dataset.storeRootUrl,
        accountDetails: '/content/wknd/us/en/my-account/account-details.html',
        resetPassword: '/content/wknd/us/en/reset-password.html'
    }
};
...
(function (window, document, Granite, $) {
    ...
    var actionOptions = [{
        selector: ".cq-project-admin-actions-approveasset",
        status: "approved",
        errorMsg: Granite.I18n.get("Failed to approve assets"),
        labelText: Granite.I18n.get("Approve"),
        dialogTitle: reviewDialogTitle,
        paramSuffix: ""
    },
        {
            selector: ".cq-project-admin-actions-rejectasset",
            status: "rejected",
            errorMsg: Granite.I18n.get("Failed to reject assets"),
            labelText: Granite.I18n.get("Reject"),
            dialogTitle: reviewDialogTitle,
            paramSuffix: ""
        },
        {
            selector: ".cq-project-admin-actions-clearstatus",
            status: "",
            errorMsg: Granite.I18n.get("Failed to clear review status on asset"),
            labelText: Granite.I18n.get("Clear Status"),
            dialogTitle: Granite.I18n.get("Clear Asset(s) Review Status"),
            paramSuffix: "@Delete"
        }];
